...
| [ClaimIDX](https://github.com/claimidx/claimidx) | Open prior-art / failure-memory index for agents. Replay-gated claims; Path B `claim --yes` shares to commons (pip ≥0.7.12). https://claimidx.com |
